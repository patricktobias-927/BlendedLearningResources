...
class Excel_School extends CI_Controller {
 
 function index()
 {
  $this->load->model("Excel_school_model");
...
//   $this->load->view("bulk_upload_of_students", $data);
 ...
 function action()
 {
  ...
  $data = $this->Excel_school_model->fetch_data();
...
// $Testingdate1 = "21-07-2021";
  ...
  header('Content-Disposition: attachment;filename="Student_school.xls"');
