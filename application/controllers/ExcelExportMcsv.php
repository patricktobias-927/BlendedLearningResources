...
//   $this->load->view("bulk_upload_of_students", $data);
 ...
 public function action()
 {
  ...
  $table_columns = array("username", "password", "first_name ", "last_name", "middle_name", "institution", "department", "email", "course1", "role1", "group1", "course2", "role2", "group2", "course3", "role3", "group3", "course4", "role4", "group4", "course5", "role5", "group5", "course6", "role6", "group6"
);
