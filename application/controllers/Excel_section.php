...
class Excel_Section extends CI_Controller {
 
 function index()
 {
  $this->load->model("Excel_section_model");
...
//   $this->load->view("bulk_upload_of_students", $data);
 ...
 function action()
 {
  ...
  $data = $this->Excel_section_model->fetch_data();
...
//    $object->getActiveSheet()->setCellValueByColumnAndRow(12, $excel_row, $Testingdate1);
  ...
  header('Content-Disposition: attachment;filename="Student_section.xls"');
